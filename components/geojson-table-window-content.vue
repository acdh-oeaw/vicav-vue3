...
const { addWindow, findWindowByTypeAndParam, addWindowIfNotPresent } = useWindowsStore();
...
function registerTable(table: Table<FeatureType>) {
	...
	addWindowIfNotPresent({ targetType: "GeojsonFilter",	params: {	url	}, title: "Variety Data - Filter Data" }, 'url');
	addWindowIfNotPresent({ targetType: "GeojsonMap", params: { url },	title: "Variety Data - Map View"	}, 'url');
}
</script>

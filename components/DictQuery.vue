<script setup lang="ts">
	...
	const QueryButtonClicked = (e: Event) => {
		e.preventDefault()
		console.log('QueryButtonClicked', e)
	}
	const UndefinedLink = (e: Event) => {
		e.preventDefault()
		console.log('UndefinedLink', e)
	}

	const normalizedQueryString = ''
	const normalizedDictList: Array<String> = []
	const dictList: Array<any> = []
	const resultHtml: Ref<string> = ref('')

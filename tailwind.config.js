	...
	theme: {
		extend: {
			...
			colors: {
				...
				"card-foreground": "hsl(var(--color-on-surface) / <alpha-value>)",
				overlay: "hsl(var(--color-overlay) / <alpha-value>)",
				"on-overlay": "hsl(var(--color-on-overlay) / <alpha-value>)",
				popover: "hsl(var(--color-overlay) / <alpha-value>)",
				"popover-foreground": "hsl(var(--color-on-overlay) / <alpha-value>)",
				muted: "hsl(var(--color-muted) / <alpha-value>)",
				"muted-foreground": "hsl(var(--color-on-muted) / <alpha-value>)",
				"on-muted": "hsl(var(--color-on-muted) / <alpha-value>)",
				primary: "hsl(var(--color-primary) / <alpha-value>)",
				"primary-foreground": "hsl(var(--color-on-primary) / <alpha-value>)",
				"on-primary": "hsl(var(--color-on-primary) / <alpha-value>)",
				secondary: "hsl(var(--color-secondary) / <alpha-value>)",
				"secondary-foreground": "hsl(var(--color-on-secondary) / <alpha-value>)",
				"on-secondary": "hsl(var(--color-on-secondary) / <alpha-value>)",
				accent: "hsl(var(--color-accent) / <alpha-value>)",
				"accent-foreground": "hsl(var(--color-on-accent) / <alpha-value>)",
				...
				destructive: "hsl(var(--color-negative) / <alpha-value>)",
				"destructive-foreground": "hsl(var(--color-on-negative) / <alpha-value>)",

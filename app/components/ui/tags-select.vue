			...
			<ComboboxViewport class="p-[5px]">
				...
				<ComboboxGroup>
					<ComboboxItem
						v-if="searchTerm"
						:key="searchTerm"
						class="relative flex h-[25px] items-center rounded-[3px] pr-[35px] pl-[25px] text-[13px] leading-none select-none data-disabled:pointer-events-none data-disabled:text-gray-300 data-highlighted:bg-secondary data-highlighted:outline-hidden"
						:value="searchTerm"
						><ComboboxItemIndicator
